...
print "correct_targets = " , np.array(correct_targets).mean(), np.array(correct_targets).std(), np.array(correct_targets).ptp(),correct_targets
print "score: ", np.array(scores).mean(), np.array(scores).std(), np.array(scores).ptp(),scores
print "gini: ", np.array(ginis).mean(), np.array(ginis).std(), np.array(ginis).ptp(),ginis
