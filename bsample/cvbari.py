...
gbr_tr_fit = GradientBoostingRegressor(n_estimators =1000,max_depth=7)
...
xfr= ExtraTreesRegressor(n_estimators =1000,max_depth=7)
...
xfr_tr_fit = ExtraTreesRegressor(n_estimators =1000,max_depth=7)
...
gbr_cat_fit = GradientBoostingRegressor(n_estimators =1000,max_depth=7)
...
xfr_cat_fit = ExtraTreesRegressor(n_estimators =1000,max_depth=7)
...
xfr_mix = ExtraTreesRegressor(n_estimators =1000,max_depth=5)
